  ...
  render() {
    return (
      <div className="home-card" >
        ...
        <h2> Discover events, organizations, and causes to support!</h2>
        <div className="search-bar" >
          ...
          <input class="search" type="text" placeholder="Search" onChange={this.search}></input>
          <button class="ui button" onClick={this.filterSearch}> Find Events</button>
        ...
        {/* <div class="ui search" >
          ...
          <div class="ui icon input">
            <input class="prompt" type="text" placeholder="Search" onChange={this.search}></input>
          </div>
          <button class="ui button" onClick={this.filterSearch}> Find Events</button>
        </div> */}
